...
OUT_DIR  = r"C:\devs\f35\scripts\f14_obj7_check"
OBJECTS  = ["Object_7_R", "Object_7_L", "Object_7_C", "Object_19_L", "Object_20_wingflap_L", "Object_20_wingflap_R"]
...
def cam_wide(z=0):
    ...
    co.location=(0, 2, z+30); co.rotation_euler=(0,0,0); bpy.context.scene.camera=co
